        ...
        listedFunctions.forEach {
            ...
            importList.addAll(
                listOf(
                    ...
                    Pair(meta.viewModelPackage, meta.viewModelName)
                )
            )
...
//                    ),
//                    viewModelName = meta.viewModelName,
//                )
//            )
        }
    ...
    private fun buildSubscriberState(hasData: Boolean): String {
        val data = if(hasData) "val data by uiDataState.collectAsState()" else ""
        return buildString {
            append("""
